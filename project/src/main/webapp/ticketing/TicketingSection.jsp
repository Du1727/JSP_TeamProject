		...
		<form id="ticketingFrm" name="ticketingFrm" method="post">
			<table class="tg" height="190" width="1600" border="0" align="center"
				...
				<tr>
					...
					<td class="tg-0lax" rowspan="3" width=150 align="center"><a
						href="javascript:submitToSelectSeat()"><img src="https://ifh.cc/g/kgDpPx.png" width="150"></a></td>
				</tr>
				<tr>
					...
					<tr>
						...
						<td class="tg-0lax" rowspan="5">
							<!-- 좌석현황배치도 --> <iframe id="seatIframe" width="100%"
								...
								src="/DEC/ticketing/TicketingSeat.jsp"></iframe>
						</td>
