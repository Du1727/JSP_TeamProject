...
if(movieNm!=null && sectionNm!=null && movieNm.length()>0 && !sectionNm.equals("null")){
	scrnListMap = new TreeMap<Integer, Vector<ScreeningInfoBean>>(tMgr.getScrnList(cityNm, sectionNm, printDate, Integer.parseInt(movieIdx), null));
}
			...
			<table class="tg2" align="center" border="1" width=1500 height="650"
				...
				<tbody>
					<tr>
						...
						<td class="tg-0lax" height="10%" align="center"><select id="selectedFilterTheater" 
							style="width: 20%;" onchange="javascript:SelectFilterTheaterNum()">
								<%
								if(screenList.size()>0){
									for (int i=0;i<screenList.size();i++) {
										TheaterBean bean = screenList.get(i);
								%>
								<option value="<%=bean.getNum()%>" <%if(filterTheaterNum!=0&&filterTheaterNum==bean.getNum()){%>
						...
						<input type="hidden" id="filterTheaterNum" name="filterTheaterNum" value="<%=filterTheaterNum%>">
						</td>
						...
						<div align="center" style="margin: 0; padding: 0">
							...
							<table>
								...
								<td width="20">
									...
									<a href="javascript:SelectFilterSeat('<%=i%>')" class="noneUnderLine">
