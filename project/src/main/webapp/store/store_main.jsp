				...
				<div class="row row-cols-1 rofw-cols-xs-3 g-4"
					...
					<div class="card" style="width: 18rem;">
						<div class="product text-center" style="height: 200px">
							...
							<a class="open-productDetail nav-link mx-auto"
								style="width: 16rem; height: 16rem;"
								onclick="modal('<%=bean2.getName()%>','<%=bean2.getDetail()%>',<%=bean2.getPrice()%>,<%=bean2.getIdx()%>)">
								<figure>
									<img class="embed-responsive-item"
										src="images/parts/store_combo_1.png"
										style="width: 200px; height: 200px;">
						...
						<div class="col p-4 d-flex flex-column position-static">
							...
							<p class="card-text mb-auto text-center" style="font-size: 20px;"><%=UtilMgr.monFormat(bean2.getPrice())%></p>
						</div>
					</div>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<%
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary customBtn"
						onclick="closeModal()">목록으로</button>
